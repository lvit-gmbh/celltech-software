...
export type FilterField = "number" | "dealer" | "model" | "order_date" | "fin_date" | "price" | "po" | "vin_num" | "shipment_id"
...
const FIELD_OPTIONS: { value: FilterField; label: string }[] = [
  ...
  { value: "fin_date", label: "Fin Date" },
  { value: "price", label: "Price" },
  { value: "po", label: "PO" },
  { value: "vin_num", label: "VIN" },
  { value: "shipment_id", label: "Shipment" },
]
